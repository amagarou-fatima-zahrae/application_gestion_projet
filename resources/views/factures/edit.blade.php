...
<div class="facture-form  py-3">
  <div class="container">
    ...
    {{-- buttons --}}
    <form method="POST" action="/facture/{{ $facture->id }}"  class="mx-5" enctype="multipart/form-data">
      @csrf
      @method('PATCH')
    <nav class="navbar navbar-expand-lg ">
        <div class="container d-flex justify-content-center bg-light px-0">
            <button type="submit" class="btn btn-success me-3">modifier</button>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li>
                <a id="ContentPlaceHolder_DeconsteButton" class="btn btn-danger navbar-btn icon deconste" href="/facture/{{ $facture->id }}/delete">Supprimer</a>
            </li>
              <li class="nav-item">
                <a class="nav-link" href="/facture/{{ $facture->id }}/generate">Envoyer</a>
              </li>
              <select class="form-select" name="statut" select="{{ $facture->statut}}" style="background-color: transparent;border:none;">
                 <option value="statut" disabled>Status</option>
                    ...
                    <div class="partie1 row  justify-content-between ">
                        ...
                        <div class="col-lg-6 col-md-12 ">
                            <div class="input-group w-100 mb-3">
                                ...
                                value="{{$user->name}}" readonly class="form-control @error('nom_Entrep') is-invalid @enderror" >
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                value="{{$user->email}}" readonly class="form-control @error('email') is-invalid @enderror" >
                                @error('email')
                         ...
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group  w-100 mb-3">
                                ...
                                value="{{$user->code_postal}}" readonly class="form-control @error('codePostal') is-invalid @enderror">
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group  w-100 mb-3">
                                ...
                                value="{{$user->tel}}" readonly class="form-control @error('tel_entrep') is-invalid @enderror" >
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                value="{{$user->compte_bancaire}}" readonly class="form-control @error('N_cptBancaire') is-invalid @enderror" >
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                value="{{$user->site_web}}" readonly class="form-control @error('site_web') is-invalid @enderror" >
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                value="{{$user->fax}}" readonly class="form-control @error('Messagecontenty') is-invalid @enderror" >
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                <input type="text"  aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                value="{{$user->address}}" readonly class="form-control @error('Messagecontenty') is-invalid @enderror"  >
                            </div>    
                         </div>
                    </div>
                    ...
                    <div class="partie2 row py-3 justify-content-between">
                       <div class="col-12 d-flex text-center align-items-center py-2 row">
                          ...
                          <div class="col-lg-12  choixClient row justify-content-between align-items-center text-center ">
                             <div class="col-lg-6 col-md-12">
                               <select name="entrep_personne" id="select"  select="{{$cli}}" class="form-select">
                       ...
                       <div class="col-lg-6 col-md-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            readonly class="form-control @error('nom_Client') is-invalid @enderror"  value="{{ $client->prenom }} {{$client->nom}}" >
                     ...
                     <div class="col-lg-6 col-md-12">
                        <div class="input-group w-100 mb-3">
                            <span class="input-group-text " id="inputGroup-sizing-default">Nom de Client</span>
                            <input type="text"  name="nom_Client" aria-label="Sizing example input"  aria-describedby="inputGroup-sizing-default"
                            readonly class="form-control @error('nom_Client') is-invalid @enderror"  value="{{$client->name}}" >
                         ...
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group  w-100 mb-3">
                                ...
                                <input type="text"  name="address_Client" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                 readonly class="form-control @error('address_Client') is-invalid @enderror"  value="{{$client->address}}">
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                <input type="text"  name="codePostal_Client" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                 readonly class="form-control @error('codePostal_Client') is-invalid @enderror"  value="{{$client->code_postal}}">
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text"  name="tel_Client" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                 readonly class="form-control @error('tel_Client') is-invalid @enderror"  value="{{$client->tel}}">
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                <input type="email"  name="email_Client" aria-label="Sizing example input"  aria-describedby="inputGroup-sizing-default"
                                 readonly class="form-control @error('email_Client') is-invalid @enderror"  value="{{$client->email}}">
                            </div>    
                         </div>
                         <div class="col-lg-6 col-md-12">
                            <div class="input-group w-100 mb-3">
                                ...
                                <input type="text"  name="fax_Client" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                 readonly class="form-control @error('address_Client') is-invalid @enderror"  value="{{$client->fax}}">
                            </div>    
                         </div>
                    </div>
                </div>
                ...
                <div class="info-droite col-lg-4 row py-3">
                    <div class="col-lg-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            <input type="text" value="{{$client->N_Client}}" name="num_client" id="numero_cli" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                     ...
                     <div class="col-lg-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            <input type="text" name="numero_fact" value="{{$facture->numero_fact}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                     ...
                     <div class="col-lg-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            <input type="date" name="date_facturation" value="{{$facture->date_facturation}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                     ...
                     <div class="col-lg-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            <input type="date" name="date_echeance" value="{{$facture->date_echeance}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                     ...
                     <div class="col-lg-12">
                        <div class="input-group w-100 mb-3">
                            ...
                            <input type="text" name="N_bon_commande" value="{{ $facture->N_bon_commande }}"  aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                     ...
                     <div class="col-lg-12">
                        <div class="form-floating w-100">
                            <textarea  placeholder="Leave a comment here" id="floatingTextarea" name="description" class="form-control @error('description') is-invalid @enderror">{{$facture->description}}</textarea>
...
{{-- ---- --}}
  ...
  <div class="table-fact">
    <div class="container">
        <table id="idTable" nb="{{ $nb }}" class="table table-striped table-hover table-bordered">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr id="ligne_{{$nb++}}">
                    <td ><input class="form-control" type="text"  value="{{ $prod->nom }}"  readonly/></td></td>
                    <input type="hidden" name="prod_serv{{$nb-1}}" value="P{{ $prod->id }}">
                    <td ><textarea class="form-control" style="height:30px" name="description_prod{{$nb-1}}" readonly>{{ $prod->description }}</textarea></td>
                    <td ><input class="form-control" name="prix{{$nb-1}}"   type="text" value="{{ $prod->prix }}" readonly /></td>
                    <td ><input class="form-control" name="quantite{{$nb-1}}" type="number" value="{{ $prod->factures()->where('facture_id',$facture->id)->first()->pivot->quantite_vendue }}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" /></td>
                    <td ><input class="form-control" type="text" name="tva{{$nb-1}}" value="{{ $prod->TVA }}"  readonly/></td>
                    <td ><input  class="form-control" type="text" name="ttc{{$nb-1}}" value="{{ ($prod->factures()->where('facture_id',$facture->id)->first()->pivot->quantite_vendue)*$prod->prix*(1+$prod->TVA)}}"  readonly /></td>
                    <td><i class="fas fa-trash fa-lg" style="color:#ca0b00;" id="dash{{$nb-1}}" ></i></td>
                  </tr>
                  @endforeach
                  @foreach ($services as $service) 
                  <tr id="ligne_{{$nb++}}">
                    <td ><input class="form-control" type="text" name="prod_serv{{$nb-1}}" value="{{ $service->nom }}"  readonly/></td></td>
                    <input type="hidden" name="prod_serv{{$nb-1}}" value="S{{ $service->id }}">
                    <td ><textarea class="form-control" style="height:30px" name="description_prod{{$nb}}" readonly>{{ $service->description }}</textarea></td>
                    <td ><input class="form-control" name="prix{{$nb-1}}"   type="text" value="{{ $service->prix }}" readonly /></td>
                    <td ><input class="form-control" name="quantite{{$nb-1}}" type="number" value="{{$service->factures()->where('facture_id',$facture->id)->first()->pivot->quantite_vendue}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" /></td>
                    <td ><input class="form-control" type="text" name="tva{{$nb-1}}" value="{{ $service->TVA }}"  readonly/></td>
                    <td ><input  class="form-control" type="text" name="ttc{{$nb-1}}" value="{{ ($service->factures()->where('facture_id',$facture->id)->first()->pivot->quantite_vendue)*$service->prix*(1+$service->TVA)}}"  readonly /></td>
                    <td><i class="fas fa-trash fa-lg" style="color:#ca0b00;" id="dash{{$nb-1}}" ></i></td>
                  </tr>
                  @endforeach
                </tbody>
        ...
        <div class="final-info row d-flex justify-content-between align-items-center py-3">
            <div class="col-lg-6 col-12-sm remarques">
                <div class="form-floating">
                    <textarea  placeholder="conditions d'escompte, paiement,retard" id="floatingTextarea2" style="height: 100px" name="condition" value="{{old('condition')}}" class="form-control @error('condition') is-invalid @enderror">{{ $facture->conditions_modalites }}</textarea>
            ...
            <div class=" col-lg-4 col-12-sm total-prix text-center">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td><input type="text"  name="total" value="{{ $facture->total }}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
...
<script>
    //statut
document.forms[0][name="statut"].value=document.forms[0][name="statut"].getAttribute("select");

   //Client
document.querySelector('select option[value='+document.forms[0][name="entrep_personne"].getAttribute("select")+']').setAttribute("selected","selected");
...
function insererLigne_Fin(){
  ...
  //console.log('lo'+inputNb.value);
    ...
    cell.innerHTML ='<textarea class="form-control" style="height:30px" name="description_prod'+nb+'" readonly></textarea>';
